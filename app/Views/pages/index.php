...
<div class=" bg-white">
  <main>
      <div class="mx-auto max-w-3xl pb-15">
        <div>
          <div>
            <h1 class="text-4xl font-bold tracking-tight sm:text-center sm:text-6xl">welcome to Hallo deck </h1>
            <p class="mt-6 text-lg leading-7 text-gray-600 sm:text-center">Tempat mencari pasangan hidup yang sefrekuensi, kenali pasanganmu dan menikahlah.<br> masa depan cerah menantimu.</p>
          </div>
        </div>
      </div>
      <div class="mx-auto max-w-3xl flex mt-10  h-72 gap-10 overflow-hidden">
